...
//string TITLE;
//
//void DrawBennyShip02(Texture2D & T2D);
//void DrawBennyShip();
...
//
//	cout << "\nCLASSIC: " << endl;
//	cout << "VERT SIZE:" << vertices.size() << endl;
//	cout << "TEXT SIZE:" << uvs.size() << endl;
//	cout << "NORM SIZE:" << normals.size() << endl;
//
...
//	Skin.InitText02("./res/textures/BMP16.bmp");
//
...
//	//glGenVertexArrays(1, &modelA.getVAO());
//	//glBindVertexArray(modelA.getVAO());
//
//	//glGenBuffers(4, m_vertexArrayBuffers);
//	//glBindBuffer(GL_ARRAY_BUFFER, m_vertexArrayBuffers[0]);
//	//glBufferData(GL_ARRAY_BUFFER, modelA.getModel().positions.size() * sizeof(modelA.getModel().positions[0]), &modelA.getModel().positions[0], GL_STATIC_DRAW);
//	//glEnableVertexAttribArray(0);
//	//glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, 0);
//
//	//glBindBuffer(GL_ARRAY_BUFFER, m_vertexArrayBuffers[1]);
//	//glBufferData(GL_ARRAY_BUFFER, modelA.getModel().positions.size() * sizeof(modelA.getModel().texCoords[0]), &modelA.getModel().texCoords[0], GL_STATIC_DRAW);
//	//glEnableVertexAttribArray(1);
//	//glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 0, 0);
//
//	//glBindBuffer(GL_ARRAY_BUFFER, m_vertexArrayBuffers[2]);
//	//glBufferData(GL_ARRAY_BUFFER,  sizeof(modelA.getModel().normals[0]) * modelA.getModel().normals.size(), &modelA.getModel().normals[0], GL_STATIC_DRAW);
//
//	//glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, m_vertexArrayBuffers[3]);
//	//glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(modelA.getModel().indices[0]) * modelA.getModel().indices.size(), &modelA.getModel().indices[0], GL_STATIC_DRAW);
//
//	//glBindVertexArray(0);
//
//
...
//
//
//	//model.initModel("./res/meshes/HM3.obj");
//	
//	//Ship.InitMesh("./res/meshes/HM3.obj", true);		
//	//Shade.initShader("basicShader");
//	 
//
//	//BackGroundSkin.InitText02("./res/textures/BG.jpg");
//	//Skin.InitText02("./res/textures/HM3_05USD.png");
//	//Skin.InitText02("./res/textures/BGUSD.jpg");
//	
//	//Skin.InitText02("./res/textures/ABUVC.png");
//	//Skin.InitText02("./res/textures/AllBoxUV.png");
//	//Skin.InitText02("./res/textures/BoxUV.png");
//
//
//	initRendering();
//	// register callbacks
...
//}
//
//void drawModel(Texture2D & T2D, Model3D Mod, float scale)
//{
//	
//	glEnable(GL_CULL_FACE);
//	glCullFace(GL_BACK);
...
//		
//		drawShipMenu(Skin);
//		//drawModel(Skin, modelA, 10);
//
//
//
//		//DrawBennyShip02(Skin);
//
//		break;
//	}
//	case 1: //GAME
